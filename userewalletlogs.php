...
<?php 
						...
						for($i=0;$i<count($ar);$i++){
							...
							if($ob->message=="Debit")
								$style = "style='background-color: rgb(255,40,40); color: black; padding: 5px;'";
							else if($ob->message=="Credit")
								$style = "style='background-color: rgb(40,255,40); color: black; padding: 5px;'";
							else
